...
public class PVoitureLouer extends JPanel implements TableModelListener {
	...
	PVoitureLouer setControleVoiture(ControleVoiture controleVoiture) {
		this.controleVoiture = controleVoiture;

		table.setModel(controleVoiture.getModele());
		controleVoiture.getModele().addTableModelListener(this);
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if( ligneSelectionnee != -1) {
					Voiture voiture = controleVoiture.getModele().getVoiture(ligneSelectionnee);
		...
		comboBoxTrie.addItem("Immatriculation");
		comboBoxTrie.addItem("Marque");
		comboBoxTrie.addItem("Modele");
		comboBoxTrie.addItem("Carburant");
		comboBoxTrie.addItem("Status");
...
//			locationEnCours.setSelected(voiture.isStatus());
	...
	private void createContents() {
		...
		lblTitre = new JLabel("");
		lblTitre.setIcon(new ImageIcon(PVoitureLouer.class.getResource("/images/gestion/client/User-Find-64.png")));
		...
		btnAction.setAction(actionRechercher);
		btnAction.setForeground(Color.BLACK);
		btnAction.setIcon(new ImageIcon(PVoitureLouer.class.getResource("/images/gestion/Search-48.png")));
		...
		btnLouer.setIcon(new ImageIcon(PVoitureLouer.class.getResource("/images/gestion/Search-48.png")));
		UI.deshabillerBouton(btnLouer, "Search");
		btnLouer.setHorizontalAlignment(SwingConstants.LEFT);
		...
		btnApercu.setIcon(new ImageIcon(PVoitureLouer.class
		...
		btnAccueil.setIcon(new ImageIcon(PVoitureLouer.class.getResource("/images/gestion/Cancel-48.png")));
...
//		txtMarque.setEditable(false);
		...
		lblTri.setIcon(new ImageIcon(PVoitureLouer.class
	...
	private class ActionLouer extends AbstractAction {
		...
		public ActionLouer() {
			putValue(NAME, "louer");
			putValue(SHORT_DESCRIPTION, "Louer la voiture disponible");
		}

		public void actionPerformed(ActionEvent e) {
			String immatriculation = txtImmatriculation.getText();
			controleVoiture.louer(immatriculation);
		}
	}
	...
	private class ActionRechercher extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			txtMarque.setEditable(true);
			String marque = txtMarque.getText();
			ArrayList<Voiture> listeVoituresMarque = new ArrayList();
			if (!marque.equals("") ) {
				listeVoituresMarque = controleVoiture.rechercherMarque(marque);
				...
				JOptionPane.showMessageDialog(null, "Aucune marque n'a pas été saisie "
...
//		public ActionLouer() {
//			putValue(NAME, "Louer");
//			putValue(SHORT_DESCRIPTION, "Louer cette immatriculation");
//		}
//
//		public void actionPerformed(ActionEvent e) {
//			//louer();

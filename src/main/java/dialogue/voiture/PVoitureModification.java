...
public class PVoitureModification extends JPanel {
	...
	PVoitureModification setControleVoiture(ControleVoiture controleVoiture) {
	 ...
	 */
	PVoitureModification() {
		this(null);
	}

	PVoitureModification(Voiture voiture) {

...
public class PVoitureRecherche extends JPanel {
	...
	PVoitureRecherche setControleVoiture(ControleVoiture controleVoiture) {
...
//		});
	...
	private void createContents() {
		...
		lblTitre = new JLabel("");
		lblTitre.setIcon(new ImageIcon(PVoitureRecherche.class.getResource("/images/gestion/client/User-Find-64.png")));
		...
		btnAction.setIcon(new ImageIcon(PVoitureRecherche.class.getResource("/images/gestion/Search-48.png")));
		...
		btnApercu.setIcon(new ImageIcon(PVoitureRecherche.class
		...
		btnAccueil.setIcon(new ImageIcon(PVoitureRecherche.class.getResource("/images/gestion/Cancel-48.png")));

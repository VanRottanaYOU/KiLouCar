...
public class PVoitureRentrer extends JPanel {
	...
	PVoitureRentrer setControleVoiture(ControleVoiture controleVoiture) {
	...
	private void createContents() {
		...
		lblTitre.setIcon(new ImageIcon(PVoitureRentrer.class.getResource("/images/gestion/client/User-Find-64.png")));
		...
		btnAction.setIcon(new ImageIcon(PVoitureRentrer.class.getResource("/images/gestion/Search-48.png")));
		...
		btnRentrer.setIcon(new ImageIcon(PVoitureRentrer.class.getResource("/images/gestion/Search-48.png")));
		UI.deshabillerBouton(btnRentrer, "Search");
		btnRentrer.setHorizontalAlignment(SwingConstants.LEFT);
		...
		panel_menu.add(btnRentrer, gbc_btnModifier);
		...
		btnApercu.setIcon(new ImageIcon(PVoitureRentrer.class
		...
		btnAccueil.setIcon(new ImageIcon(PVoitureRentrer.class.getResource("/images/gestion/Cancel-48.png")));
...
//	}
	...
	private class ActionRentrer extends AbstractAction {
		...
		public ActionRentrer() {
			...
			putValue(SHORT_DESCRIPTION, "Rentrer la voiture");
		}
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (!immatriculation.equals("")) {	
				...
				if (maVoiture.getImmatriculation() != null)
				{
					...
					txtMarque.setText(maVoiture.getMarque());
					txtCarburant.setText(maVoiture.getCarburant());
					controleVoiture.rentrer(immatriculation);
				}else {
					txtImmatriculation.setText("");
					txtModele.setText("");
					txtMarque.setText("");

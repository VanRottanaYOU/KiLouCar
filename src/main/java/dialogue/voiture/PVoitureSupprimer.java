...
public class PVoitureSupprimer extends JPanel {
	...
	PVoitureSupprimer setControleVoiture(ControleVoiture controleVoiture) {
	...
	private void createContents() {
		...
		lblTitre = new JLabel("Supprimer");
		lblTitre.setIcon(new ImageIcon(PVoitureSupprimer.class.getResource("/images/gestion/client/User-Find-64.png")));
		...
		btnAction.setIcon(new ImageIcon(PVoitureSupprimer.class.getResource("/images/gestion/Search-48.png")));
		...
		btnSupprimer.setIcon(new ImageIcon(PVoitureSupprimer.class.getResource("/images/gestion/Search-48.png")));
		UI.deshabillerBouton(btnSupprimer, "Search");
		...
		btnApercu.setIcon(new ImageIcon(PVoitureSupprimer.class
		...
		btnAccueil.setIcon(new ImageIcon(PVoitureSupprimer.class.getResource("/images/gestion/Cancel-48.png")));
...
//	}
	...
	private class ActionSupprimer extends AbstractAction {
		...
		public ActionSupprimer() {
			...
			putValue(SHORT_DESCRIPTION, "Supprimer la voiture");
		}
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (!immatriculation.equals("")) {	
				...
				if (maVoiture.getImmatriculation() != null)
				{
					controleVoiture.supprimer(immatriculation);		
